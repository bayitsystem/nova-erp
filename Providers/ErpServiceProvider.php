...
namespace NovaModules\Erp\Providers;
...
class ErpServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = "NovaModules\Erp";
    ...
    public function boot()
    {
        ...
        Nova::serving(function (ServingNova $event) {
            ...
            Nova::script('erp', __DIR__.'/../dist/js/erp.js');
            Nova::style('erp', __DIR__.'/../dist/css/erp.css');
        });
    }
    ...
    protected function registerViews()
    {
        ...
        $viewPath = resource_path('views/nova-modules/erp');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
                return $path . '/nova-modules/erp';
            }, \Config::get('view.paths')), [$sourcePath]), 'erp');
    ...
    protected function resources()
    {
        ...
        foreach ((new Finder)->in($directory)->files() as $resource) {
            $resource = str_replace(
                '.php',
                '',
                $namespace."\\Resources\\".Str::afterLast($resource->getFilename(), '\\')
            );
